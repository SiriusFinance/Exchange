...
export const isCryptoPool = poolName => cryptoPools.includes(poolName)

const nativePools = [NASTR_NAME]
export const isNativePool = poolName => nativePools.includes(poolName)

const XTriSwapPools = []
export const isXTriSwapPool = poolName => XTriSwapPools.includes(poolName)
